...
namespace Gen
{
    ...
    namespace Configuration
    {
        ...
        {
            using Tuple = std::tuple<int64, string, int64, std::shared_ptr<std::vector<std::shared_ptr<Attr::Tuple>>>, std::shared_ptr<std::vector<int64>>, std::shared_ptr<Vector3::Tuple>>;
            /* 怪物Id */
            int64 monsterId;
            /* 怪物名 */
            string name;
            ...
            int64 level;
            /* 属性 */
            std::shared_ptr<std::vector<std::shared_ptr<Attr>>> attrs;
            /* 技能列表 id#id */
